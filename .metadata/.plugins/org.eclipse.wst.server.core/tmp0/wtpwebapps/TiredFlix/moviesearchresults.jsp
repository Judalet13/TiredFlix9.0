...
<body>
	...
	<jsp:include page="header.jsp">
		<jsp:param value="Search Results" name="pageTitle" />
	</jsp:include>
	<c:if test="${empty films }">
		<div class="w3-panel w3-margin w3-card-4 w3-white">
			<a href="search.jsp" class="w3-center">
				<h3>
					<b>No Movies Matched Your Search. Click to Search Again</b>
				</h3>
	...
	<c:forEach items="${films}" var="film">
		<div class="w3-panel w3-margin w3-card-4 w3-white">
			<a href="${detailServlet }?film_id=${film.filmID }"> <img
				src="moviePosters/${film.posterImage }" alt="${film.title }"
